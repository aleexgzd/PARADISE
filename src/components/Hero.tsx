  ...
  return (
    <section className="hero" aria-label="Bienvenida">
      ...
      <div className="hero-content">
        <span className="hero-tag reveal"><span className="dot" /> Açaí Paradise · Granada · Sevilla</span>
        <h1 className="reveal d1">El paraíso<br />cabe en un<br /><span className="em">bowl</span></h1>
        <p className="sub reveal d2">Açaí y smoothies en Granada y Sevilla. Sin teorías, sin sermones. Solo un bowl que sabe bien.</p>
