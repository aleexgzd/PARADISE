    ...
    <section className="manifesto" id="manifiesto">
      <div className="manifesto-grid">
        <div className="manifesto-text">
          ...
          <p className="reveal d2"><strong>Sin complicaciones, sin postureo.</strong> Un bowl que sabe bien, una cuchara y un rato que no te esperabas.</p>
          <p className="reveal d3">Abrimos en Granada porque echábamos de menos un sitio donde merendar bien sin complicarse. Sevilla vino después. Lo que viene, ya se verá.</p>
        </div>
