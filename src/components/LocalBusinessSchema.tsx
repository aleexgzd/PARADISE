...
const schema = {
  ...
  '@graph': [
    {
      '@type': 'WebSite',
      '@id': 'https://www.acaiparadise.es/#website',
      url: 'https://www.acaiparadise.es',
      name: 'Açaí Paradise',
      description: 'Bowls de açaí y smoothies en Granada y Sevilla.',
      publisher: { '@id': 'https://www.acaiparadise.es/#org' },
      inLanguage: 'es',
    },
    {
      '@type': 'Restaurant',
      '@id': 'https://www.acaiparadise.es/#granada',
      ...
      url: 'https://www.acaiparadise.es/granada',
      email: 'info@acaiparadise.es',
      image: 'https://www.acaiparadise.es/assets/837abd8c6f.webp',
    ...
    {
      '@type': 'Restaurant',
      '@id': 'https://www.acaiparadise.es/#sevilla',
      ...
      url: 'https://www.acaiparadise.es/sevilla',
      email: 'info@acaiparadise.es',
      image: 'https://www.acaiparadise.es/assets/144c64bb4a.webp',
      servesCuisine: ['Açaí bowls', 'Smoothies', 'Bowls de fruta'],
      priceRange: '€',
      currenciesAccepted: 'EUR',
      paymentAccepted: 'Efectivo, Tarjeta, Bizum',
    ...
    {
      '@type': 'FAQPage',
      '@id': 'https://www.acaiparadise.es/#faq',
      mainEntity: [
        {
          '@type': 'Question',
          name: '¿Qué es el açaí?',
    ...
    {
      '@type': 'Organization',
      '@id': 'https://www.acaiparadise.es/#org',
      name: 'Açaí Paradise',
      url: 'https://www.acaiparadise.es',
      logo: 'https://www.acaiparadise.es/assets/logo-full-blue.png',
      email: 'info@acaiparadise.es',
      sameAs: socialLinks,
    },
  ],
