        ...
        <div className="stores-grid">
          <article className="store reveal">
            ...
            <div className="store-body" itemScope itemType="https://schema.org/Restaurant">
              ...
              <div className="store-ctas">
                <a href="https://www.google.com/maps/search/Açaí+Paradise+Granada" target="_blank" rel="noopener" className="btn btn-dark">Cómo llegar <span className="arrow">→</span></a>
          ...
          <article className="store reveal d1">
            ...
            <div className="store-body" itemScope itemType="https://schema.org/Restaurant">
              ...
              <div className="store-ctas">
                <a href="https://www.google.com/maps/search/Açaí+Paradise+Sevilla" target="_blank" rel="noopener" className="btn btn-dark">Cómo llegar <span className="arrow">→</span></a>
