...
export const GRANADA: CityData = {
  ...
  gallery: [
    { src: '/assets/acai-granada-fachada.jpg', alt: 'Local de Açaí Paradise en el centro de Granada con gente en la puerta' },
    { src: '/assets/acai-granada-plaza.jpg', alt: 'Bowl de açaí en la mano con la tienda de Açaí Paradise Granada al fondo' },
    { src: '/assets/acai-granada-escaparate.jpg', alt: 'Escaparate y entrada de Açaí Paradise en el centro de Granada' },
    { src: '/assets/acai-granada-bowl.jpg', alt: 'Acai bowl con plátano, fresa y arándanos en Granada' },
    { src: '/assets/acai-granada-local.jpg', alt: 'Neón de la palmera de Açaí Paradise en el escaparate de Granada' },
    { src: '/assets/bowls-acai-granada.jpg', alt: 'Dos acai bowls con fruta fresca, granola y crema en Granada' },
  ],
  faq: [
    {
...
export const SEVILLA: CityData = {
  ...
  gallery: [
    { src: '/assets/acai-sevilla-fachada.jpg', alt: 'Fachada de Açaí Paradise en el centro de Sevilla' },
    { src: '/assets/acai-sevilla-barra.jpg', alt: 'Mostrador de Açaí Paradise Sevilla con las pantallas para personalizar tu bowl' },
    { src: '/assets/acai-sevilla-interior.jpg', alt: 'Interior de Açaí Paradise Sevilla con plantas y madera natural' },
    { src: '/assets/bowls-acai-sevilla.jpg', alt: 'Dos acai bowls con fruta fresca y granola en Sevilla' },
    { src: '/assets/acai-sevilla-atardecer.jpg', alt: 'Bowl de açaí con dos cucharas al atardecer en Sevilla' },
    { src: '/assets/acai-sevilla-preparacion.jpg', alt: 'Preparación de un bowl de açaí con fresas frescas en Sevilla' },
  ],
  faq: [
    {
